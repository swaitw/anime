import { Matrix4, Vector3, Euler, Quaternion, Color, BatchedMesh, SRGBColorSpace } from 'three';
import { degToRad, radToDeg } from '../../utils/number.js';
import { threeAdapter } from './adapter.js';
import { COLOR_NORM, applySkewOrigin, readScalar, writeScalar, readColorHex, PATH_DIRECT } from './helpers.js';
 ...
 * @param {InstanceParent} mesh
 */
export function commitChanges(mesh) {
 ...
 */
export function getInstances(mesh) {
